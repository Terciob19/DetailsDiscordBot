    ...
    switch (parentID)
    {
        ...
        case categoryDetailsDamageMeter:
            switch (command)
            {
                ...
                case 'combatlog':
                    return `Raw combatlogs is required to study the case, please get on a group, type **/combatlog**, play normally, close your game and get the file from \World of Warcraft\**VERSION**\Logs\WoWCombatLog-date.txt. On VERSION is retail for current content; classic for TBC; classic_era for Vanilla`;
